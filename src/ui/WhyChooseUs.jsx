  ...
  return (
    <section className="flex items-center justify-center flex-col mt-5 text-stone-900 px-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 py-10 text-center">
        {whyChooseUsArray.map((obj) =>  <div key={obj.name} className="flex flex-col items-center hover:translate-y-[-5px] bg-purple-100 p-4 rounded-xl  hover:shadow-md transition-all duration-100 ">
